...
if __name__ == "__main__":
    ...
    print("test_text_arr[0:2] :", test_text_arr[0:2])
    print("test_tags_arr[0:2] :", test_tags_arr[0:2])
    ...
    print("test_tags :", test_tags[0:2])
    slots_num = len(tags_to_array.label_encoder.classes_)
    print("slot num :", slots_num, tags_to_array.label_encoder.classes_)
    
    print("test input shape :", test_input_ids.shape, test_input_ids[0:2])
    print("test_input_mask :", test_input_mask.shape, test_input_mask[0:2])
    print("test_segment_ids :", test_segment_ids.shape, test_segment_ids[0:2])
    print("test_tags :", test_tags.shape, test_tags[0:2])
    ########################################################################
